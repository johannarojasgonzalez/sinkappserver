...
public class SinkController {
	...
	@ResponseBody
	public Long save(@PathVariable("userImi") String userImi, @PathVariable("checkReferenceExits") String checkReferenceExits,
			@PathVariable("updateAll") String updateAll, @PathVariable("stepBefore") String stepBefore, @RequestBody SinkBean sink) {
	...
	public SinkBean[] search(@PathVariable("startDate") @DateTimeFormat(pattern = DD_MM_YYYY) Date startDate,
			@PathVariable("endDate") @DateTimeFormat(pattern = DD_MM_YYYY) Date endDate, @PathVariable("clientName") String clientName,
		...
		ArrayList<SinkBean> results = sinkService.findAllSinksByDateAnClientAndReference(startDate, endDate, clientName, reference);
	...
	@ResponseBody
	public Boolean searchPairReferenceClient(@PathVariable("clientName") String clientName, @PathVariable("reference") String reference,
