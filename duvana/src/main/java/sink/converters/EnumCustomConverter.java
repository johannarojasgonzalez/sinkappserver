...
public class EnumCustomConverter implements CustomConverter {
	...
	public Object convert(Object existingDestinationFieldValue, Object sourceFieldValue, Class destinationClass, Class sourceClass) {
		...
		}else if (SinkStatusEnum.class.isAssignableFrom(destinationClass) && Long.class.isAssignableFrom(sourceClass)) {
			return SinkStatusEnum.getSinkStatusEnumById((Long) sourceFieldValue);
		}else if (SinkDiameterEnum.class.isAssignableFrom(destinationClass) && Long.class.isAssignableFrom(sourceClass)) {
			return SinkDiameterEnum.getSinkDiameterEnumById((Long) sourceFieldValue);
		} else if (SinkPlumbOptionEnum.class.isAssignableFrom(destinationClass) && Long.class.isAssignableFrom(sourceClass)) {
		...
		throw new IllegalArgumentException("This CustomConverter can only convert Strings and Enums!\nArguments passed in were: '" + destinationClass
				+ "' and '" + sourceClass + "'");
	}
